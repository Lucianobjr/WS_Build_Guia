  ...
  return (
    <ScrollView>
        <View style={styles.containerImage}>
            <Image style={styles.backgroundImage} source={require('./img/Priest.png')} />
            <View>
        ...
        <View style={styles.describe}>
            ...
            Os sacerdotes escolheram o caminho da misericórdia. Eles tiram seu poder mágico das 
            mãos do próprio Harad. Como curandeiros hábeis, eles podem rapidamente restaurar os 
            poderes de vida dos aliados que sofreram até mesmo as feridas mais mortais. A luz solar 
            juda os sacerdotes a dissipar a Escuridão, e ao enfraquecer os inimigos, eles aproximam 
            sua derrota. Em momentos de extremo perigo, o Padre pode trazer as lágrimas de Harad sobre 
            as cabeças dos inimigos que ousam desafiar o bem.
            </Text>
        </View>
        ...
        <View style={styles.containerInitial}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/LagrimasHarad.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/LagrimasHarad.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Lágrimas de Harad</Text>
                                
                                <Pressable
                                    style={{width: 30, height: 25, backgroundColor: '#000', margin: 3, marginLeft: 77, borderRadius: 5,}}
                                    onPress={() => {
                                    setFirst(!first)
                                    }}
                                >
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>As lágrimas de Harad caem sobre o inimigo, causando dano mágico. Se o sacerdote ou os membros
                                    do grupo dele forem atacados, é possível que as lágrimas de Harad também caiam sobre eles.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/PalavraPoder.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/PalavraPoder.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Palavra de Poder</Text>
                            ...
                            <Text style={styles.textModal}>Lança uma maldição em um inimigo. Se o alvo usar uma habilidade que consuma energia, ele também 
                                perderá um percentual do total de energia dele. A quantidade de energia perdida e a duração do efeito aumentam conforme o nível 
                                da habilidade.
                            </Text>
                        </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Armisticio.png')} />
                    <Text style={styles.textSkill}>1/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Armisticio.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Armistício</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Enquanto estiver sob o efeito dessa habilidade, o alvo não poderá atacar o sacerdote, nem 
                                    o sacerdote poderá atacar o alvo. Entretando, os outros inimigos do alvo passarão a causar mais dano contra ele.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Cria um forte escudo ao redor do personagem ou de um aliado, que absorverá uma determinada 
                                    quantidade de dano. O dano absorvido pelo escudo aumenta conforme o nível da habilidade.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ToqueCura.png')} />
                    <Text style={styles.textSkill}>5/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 50, height: 50, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ToqueCura.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Toque de Cura</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Restaura com poder mágico uma quantidadde de pontos de vida do personagem ou de um aliado 
                                    instantaneamente.
                                </Text>
                            </View>
                        </Modal>      
        ...
        <View style={styles.containerInitial2}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/AuraValor.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 48, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/AuraValor.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Aura de Valor</Text>
                            ...
                            <View style={{margin: 3,}}>
                                <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>26 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>70 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>O sacerdote cria uma aura que aumenta os poderes físicos e mágico. Ela afetará todos os aliados
                                    em determinado raio.
                                </Text>
                            </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/AuxilioDivino.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 54, height: 54, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/AuxilioDivino.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Auxílio Divino</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta a chance, o poder de um ataque crítico e a velocidade de ataque do personagem.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Redencao.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 54, height: 54, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Redencao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Redenção</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Uma pequena porção de vida é restaurada para os aliados na área selecionada e os efeitos 
                                    negativos são destruidos.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Ressureicao.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 54, height: 55, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Ressureicao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Ressureição</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Revive instantaneamente um membro do grupo dentro do raio de vários metros do personagem 
                                    , transportando-o para o conjurador. Não pode ser usado durante combates na arena.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FardoExaustivo.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 55, height: 54, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/FardoExaustivo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Fardo Exaustivo</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Imobiliza o inimigo e reduz o seu poder mágico e físico por um tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/PunicaoLuz.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 52, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/PunicaoLuz.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Punição da Luz</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Um ataque mágico que causa dano ao alvo e a todos os adversários dentro de um metro do alvo 
                                    ao atacá-lo com sucesso, e tem uma chance de impedir que os adversários usem suas habilidades por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Desforra.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 54, height: 55, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Desforra.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Desforra</Text>
                            ...
                            <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                ...
                                <Text style={styles.textModal}>Ataque mágico que causa dano ao inimigo. Causa dano mágico a mais dependendo da vida atual 
                                    do inimigo: quanto menos vida, maior o dano.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/AmeacaArdilosa.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/AmeacaArdilosa.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Ameaça Ardilosa</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>conjura uma magia que reduz a vida e a energia do inimigo enquanto ele se mover.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/MarcaMistica.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 54, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/MarcaMistica.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Marca Mística</Text>
                            ...
                            <View style={{margin: 3,}}>
                                <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>5 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Consumo de energia: <Text style={{color: '#0f0',}}>8 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>5 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Evoca uma marca mística sobre o inimigo, diminuindo suas defesas física e mágica. Quando a 
                                    marca é removida, o alvo sofre dano mágico. Se um inimigo receber 3 dessas marcas, todos os inimigos dentro de um pequeno 
                                    raio do alvo sofrerão dano.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
