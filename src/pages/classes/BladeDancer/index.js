  ...
  return (
    <ScrollView>
        <View style={styles.containerImage}>
            <Image style={styles.backgroundImage} source={require('./img/BladeDancer.png')} />
            <View>
        ...
        <View style={styles.describe}>
            ...
            Dançarinos da lâminas são mestres da espada. Eles usam espadas feitas de aço elven leve. 
            Duas lâminas nas mãos de um elfo tornam-se obedientes, armas mortais tanto no ataque 
            quanto na defesa. Os espadachins elven são capazes de parar inimigos porque eles podem 
            privar temporariamente os agressores de suas habilidades mágicas e reduzir o dano que 
            eles causam.
            </Text>
        </View>
        ...
        <View style={styles.containerInitial}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/GolpeRelampago.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/GolpeRelampago.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Golpe Relâmpago</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Um ataque impetuoso com a arma, que causa muito dano físico. O dano aumenta conforme o nível da 
                                    habilidade.
                                </Text>
                            </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Agressao.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 53, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Agressao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Agressão</Text>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Aparo.png')} />
                    <Text style={styles.textSkill}>1/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 49, height: 49, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Aparo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Aparo</Text>
                                
                                <Pressable
                                    style={{width: 30, height: 25, backgroundColor: '#000', margin: 3, marginLeft: 182, borderRadius: 5,}}
                                    onPress={() => {
                                    setThree(!three)
                                    }}
                                >
                            ...
                            <View style={{margin: 3,}}>
                                <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>17 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>20 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Aumenta a chance de aparar ataques corpo a corpo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Aturdir.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 52, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Aturdir.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Aturdir</Text>
                                
                                <Pressable
                                    style={{width: 30, height: 25, backgroundColor: '#000', margin: 3, marginLeft: 175, borderRadius: 5,}}
                                    onPress={() => {
                                    setFour(!four)
                                    }}
                                >
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Reduz a velocidade de ataque e o dano do inimigo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/CortarTendao.png')} />
                    <Text style={styles.textSkill}>5/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 53, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/CortarTendao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Cortar Tendão</Text>
                            ...
                            <View style={{margin: 3,}}>
                                <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Alcance de uso: <Text style={{color: '#0f0',}}>2 metros</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>15 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>15 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Um golpe que mutila o alvo, imobilizando-o por algum tempo. O inimigo fica impossibilitado de usar 
                                    habilidades.
                                </Text>
                            </View>
                        </Modal>      
        ...
        <View style={styles.containerInitial2}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ExplosaoSonica.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 48, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ExplosaoSonica.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Explosão Sônica</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Um golpe rápido das duas armas cria uma forte onda sonora que infliqe dano aos adversários e 
                                    inimigos vizinhos.
                                </Text>
                            </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TransformacaoMagica.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 48, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/TransformacaoMagica.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Transformação Mágica</Text>
                            ...
                            <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                ...
                                <Text style={styles.textModal}>O personagem é envolto em um escudo que consome parte do dano recebido.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/PoderLaminas.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3}}>
                                    <Image style={styles.ImageModal} source={require('./img/PoderLaminas.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Poder das Lâminas</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Ataques básicos de um espadachim causam mais dano a jogadores e monstros. Com o desenvolvimento 
                                    da habilidade, o bônus extra aumenta.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Esclarecimento.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1}}>
                                    <Image style={styles.ImageModal} source={require('./img/Esclarecimento.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Esclarecimento</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta a precisão do héroi e a chance de se esquivar de ataques.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/InvestidaFuracao.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1,}}>
                                    <Image style={styles.ImageModal} source={require('./img/InvestidaFuracao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Investida Furacão</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta a velocidade de ataque e de recarga de habilidade do personagem por uma porcentagem 
                                    determinada durante algum tempo.
                                </Text>
                ...
                <View style={styles.borderSkill}>
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 49, height: 49, borderWidth: 2, borderColor: '#fa0',}}>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O Dançarino da Lâmina corre até uma área específica e , com alguma chance, atordoa os inimigos lá 
                                    presentes. Todos os inimigos com que o Dançarino da Lâmina encontrar no período de investida o atacarão por determinado tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/EspiritoResistencia.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3}}>
                                    <Image style={styles.ImageModal} source={require('./img/EspiritoResistencia.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Espirito da Resistência</Text>
                            ...
                            <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                ...
                                <Text style={styles.textModal}>Aplica vários auxílios de resistência ao personagem por algum tempo. Cada efeito permite que você 
                                    ignore o efeito negativo recebido pelo personagem, incluindo o efeito de controle. Se qualquer efeito negativo for ignorado, 
                                    um auxílio de resistência será removido.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/MarcaLamina.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1}}>
                                    <Image style={styles.ImageModal} source={require('./img/MarcaLamina.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Marca da Lâmina</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Diminiui os parâmetros de "Evasão" e "Aparo" de um inimigo e aumenta o parâmetro "Penetração" do 
                                    personagem por um tempo determinado.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ContraAtaque.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1}}>
                                    <Image style={styles.ImageModal} source={require('./img/ContraAtaque.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Contra Ataque</Text>
                            ...
                            <View style={{margin: 3,}}>
                                <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>20 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>30s s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Aplica o efeito "Contra-ataque" no personagem por um tempo. Ao receber dano, causa dano físico 
                                    de volta a um inimigo igual à quantidadde do próprio poder físico.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
