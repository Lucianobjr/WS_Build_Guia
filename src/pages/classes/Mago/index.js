    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.containerImage}>
                <Image style={styles.backgroundImage} source={require('./img/Mage.png')} />
                <View>
            ...
            <View style={styles.describe}>
                <Text style={styles.describeText}>
                    Os Magos Escolhidos passam muito tempo em busca de entidades elementares e 
                    arcos mágicos. Magos agem de forma rápida e resoluta no campo de batalha, 
                    eles reduzem inimigos a cinzas e trazem pedras enormes sobre suas cabeças. 
                    Às vezes parece que os magos são imbatíveis, pois são capazes de se cercar 
                    de escudos mágicos, e em momentos de extremo perigo, jogam para trás assailents 
                    e desaparecem por teletransporte.
                </Text>
            </View>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/BolaFogo.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/BolaFogo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Bola de Fogo</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Lança uma bola de fogo, causando dano mágico
                                aumentado ao alvo. Se o alvo estiver efeito de chão ardente, haverá uma
                                chance de ser afetado também pela Habilidade Medo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/DistorcaoTemporal.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/DistorcaoTemporal.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Distorção Temporal</Text>
                            ...
                            <Text style={styles.textModal}>O mago se desloca para um ponto específico, causando dano de magia a todos os inimigos
                                dentro de uma pequena área.
                            </Text>
                        </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/MeteorosPedras.png')} />
                    <Text style={styles.textSkill}>5/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 53, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/MeteorosPedras.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Estilhaços de Pedra</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O mago ergue estilhaços de pedra no ar. Causa dano de magia solar a todos os inimigos
                                    ao redor dele. Há uma pequena possibilidade de atordoar os inimigos.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/CorrentesIlusorias.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 50, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/CorrentesIlusorias.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Correntes Ilusórias</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O mago afasta todos os inimigos próximos a ele. Os inimigos afastados são presos ao chão
                                    com correntes ilusórias e não podem se mover por algum tempo. A distância de afastamento e a duração das correntes
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ArmaduraSolar.png')} />
                    <Text style={styles.textSkill}>1/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 50, height: 50, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ArmaduraSolar.png')}/>
                                </View>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta a resistência do personagem a todos os tipos de dano por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/OlhoDragao.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 48, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/OlhoDragao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Olho do Dragão</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>23 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>30 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Aumenta a velocidade de ataque do personagem ou do aliado, aumenta a precisão por determinado
                                    período e oferece a possibilidade de ver inimigos camuflados. Para cada golpe, o personagem restaura um pouco de energia.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/BarreiraEterea.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 48, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/BarreiraEterea.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Barreira Etéria</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Quando uma determinada quantidadde de dano é recebida, o personagem recebe uma barreira 
                                protetora que absorve o dano dos ataques seguintes.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ChaoArdente.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 48, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ChaoArdente.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Chão Ardente</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O solo na área selecionada se incendeia. Os inimigos na área sofrerão dano constante enquanto
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FogoOfuscante.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 50, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/FogoOfuscante.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Fogo Ofuscante</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Ataque mágico que causa dano ao alvo e a todos os inimigos dentro de um metro. Também reduz o parâmetro de precisão
                                     do alvo principal por algum tempo. Ao se utilizar a habilidade flecha congelante enquanto o auxílio 
                                     estiver ativo, o alvo será atordoado por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Enobrecimento.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 50, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Enobrecimento.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Enobrecimento</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Remove todos os efeitos negativos, incluindo os efeitos de controle, do personagem
                                    ou de seu aliago e ignora-os por algum tempo.
                                    O tempo de efeito aumenta conforme o nível de habilidade.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ban.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ban.png')}/>
                                </View>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Causa o efeito negativo Absorção de Tempo ao adversário por uma determinada duração. Este 
                                    Efeito remove vários auxílios e diminui a duração de novos auxílios concedidos ao adversário por habilidades.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Sobrecarga.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Sobrecarga.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Sobrecarga</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Sempre que alguma habilidade for usada, o personagem ganhará um auxílio; com cinco 
                                    auxílios, o efeito positivo "Sobrecarga" se aplicará ao personagem. A sobrecarga aplica dano ao longo do tempo 
                                    ao inimigo com o próximo ataque automático.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FlechaGelo.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 52, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/FlechaGelo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Flecha Congelante</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Ataque mágico que causa dano ao inimigo e diminui sua velocidade de ataque por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/AuraFogo.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/AuraFogo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Aura de Fogo</Text>
                            ...
                            <View style={{margin: 3,}}>
                                <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>20 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Consumo de energia: <Text style={{color: '#0f0',}}>6 unidades em 3 s</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>8 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Garante o efeito positivo "Aura de fogo" em um personagem por um tempo determinado. A aura flamejante
                                    causa dano mágico a todos os inimigos dentro do raio de um metro a cada 3 segundos. Habilidade com consumo constante de energia.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
