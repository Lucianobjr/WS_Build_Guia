  ...
  return (
    <ScrollView>
        <View style={styles.containerImage}>
            <Image style={styles.backgroundImage} source={require('./img/Hunter.png')} />
            <View>
        ...
        <View style={styles.describe}>
            ...
            Caçadores passam a maior parte da vida em florestas densas nas montanhas, 
            aperfeiçoando suas artes marciais. Envoltos por uma armadura leve, eles 
            preferem não se envolver em combates corpo a corpo: Caçadores sempre destroem 
            inimigos usando arcos e balestras. Eles têm facilidade para atordoar um adversário 
            ou feri-lo gravemente, concentrando todo o ódio em um disparo.
            </Text>
        </View>
        ...
        <View style={styles.builds}>
            <View>
                <Text style={styles.buildText}>Builds</Text>
            </View>
            <View>
                <Text style={styles.build1}>1</Text>
            </View>
            <View>
                <Text style={styles.build1}>2</Text>
            </View>
        </View>
        <View style={styles.containerInitial}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TiroFatal.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 55, height: 54, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/TiroFatal.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Tiro Fatal</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Disparo que causa dano físico extra ao inimigo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TiroAtordoante.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 55, height: 54, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/TiroAtordoante.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Tiro Atordoante</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>12 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>17 s</Text></Text>
                            </View>
                            <Text style={styles.textModal}>Disparo que causa o efeito negativo "Atordoar" ao inimigo por algum tempo. O adversário não pode se 
                                mexer ou aplicar habilidades. Danos sofridos pelo alvo não prejudicam o efeito.
                            </Text>
                        </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FlechaEnvenenada.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 53, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/FlechaEnvenenada.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Flecha Envenenada</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Disparo que causa o efeito negativo "Envenenamento" ao inimigo por algum tempo. O adversário 
                                    recebe dano físico periodicamente. É possível aplicar vários efeitos a um só adversário.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/AgilidadeCacador.png')} />
                    <Text style={styles.textSkill}>1/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 53, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/AgilidadeCacador.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Agilidade do Caçador</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta o parâmetro de "Esquiva" do personagem por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/PosturaCombate.png')} />
                    <Text style={styles.textSkill}>5/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 54, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/PosturaCombate.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Postura de Combate</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={{fontSize: 18, color: '#fff',}}>Consumo de energia: <Text style={{color: '#0f0',}}>6 unidades em 2s</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>8 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Aumenta o poder físcio do personagem e a chance de causar acerto crítico ao inimigo enquanto a 
                                    habilidade durar. Habilidade com consumo de energia constante.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
        ...
        <View style={styles.containerInitial2}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FlechaGuia.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/FlechaGuia.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Flecha Guia</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Disparo que causa dano físico ao alvo e a todos os inimigos dentro de um raio de alguns metros 
                                    do alvo. Os alvos subsequentes ao alvo principal recebem 10% a menos de dano.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FlechaExplosiva.png')} />
                    <Text style={styles.textSkill}>2/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                            setSeven(!seven);
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, }}>
                                    <Image style={styles.ImageModal} source={require('./img/FlechaExplosiva.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Flecha Explosiva</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Disparo que causa dano físico ao alvo e uma porcentagem específica desse dano a todos os inimigos 
                                    dentro de um raio de alguns metros do alvo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/InstintosMontanhas.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3,}}>
                                    <Image style={styles.ImageModal} source={require('./img/InstintosMontanhas.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Instintos das Montanhas</Text>
                                
                                <Pressable
                                    style={{width: 30, height: 25, backgroundColor: '#000', margin: 3, marginLeft: 40, borderRadius: 5,}}
                                    onPress={() => {
                                    setEight(!eight)
                                    }}
                                >
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta a velocidade de ataque e o parâmetro de penetração do personagem por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/MarcaCacador.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/MarcaCacador.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Marca do Caçador</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aplica o auxílio Êxtase do Caçador a um personagem por algum tempo. Ao atacar, o personagem aplica 
                                    a penalidade Marca do Caçador ao inimigo, o que aumenta por um tempo o dano recebido pelo inimigo de qualquer caçador. Vários 
                                    efeitos podem ser aplicados ao mesmo inimigo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ArmadilhaGuardaFlorestal.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/ArmadilhaGuardaFlorestal.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Armadilha da Guarda Florestal</Text>
                                
                                <Pressable
                                    style={{width: 30, height: 25, backgroundColor: '#000', margin: 3, marginLeft: -1, borderRadius: 5,}}
                                    onPress={() => {
                                    setTen(!ten)
                                    }}
                                >
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Posiciona uma armadilha invisível para os adversários na área específica por algum tempo. A 
                                    armadilha causa dano físico ao alvo e a todos os adversários em um raio de um metro do alvo e tem uma certa chance de causar 
                                    atordoamento por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FlechaConfusao.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 52, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/FlechaConfusao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Flecha da Confusão</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Disparo que causa o efeito negativo "Medo" ao alvo e a todos os inimigos em um raio de alguns 
                                    metros do alvo por algum tempo. Os adversários ficam descontrolados e o dano causado a eles pode remover o efeito.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FlechaSilencio.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/FlechaSilencio.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Flecha do Silêncio</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Disparo que bloqueia a capacidade do inimigo de usar habilidades por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/BencaoMontanhas.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/BencaoMontanhas.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Benção das Montanhas</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Diminui todo o dano recebido pelo personagem e aumenta seu parâmetro de "Evasão" por um tempo 
                                    determinado.
                                </Text>
                            </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TiroEnfraquecedor.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, width: 53, height: 53, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/TiroEnfraquecedor.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Tiro Enfraquecedor</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Disparo que reduz o poder mágico e físico do inimigo e a velocidade de ataque por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
