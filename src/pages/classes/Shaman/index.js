  ...
  return (
    <ScrollView>
        <View style={styles.containerImage}>
            <Image style={styles.backgroundImage} source={require('./img/Shaman.png')} />
            <View>
        ...
        <View style={styles.describe}>
            ...
            Xamãs são os feiticeiros glorificados dos clãs das montanhas. Eles usam seus 
            funcionários para lançar feitiços devastadores e poderosos. O conhecimento 
            secreto dos xamãs é usado para ajudar os aliados, bem como obter grande poder. 
            Feiticeiros da montanha podem atingir inimigos com raios ou até mesmo causar 
            um terremoto.
            </Text>
        </View>
        ...
        <View style={styles.containerInitial}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/EsferaRelampejante.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 51, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/EsferaRelampejante.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Esfera Relampejante</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Esfera Relampejante atinge o alvo com ataque mágico.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/EspiritoRestaurador.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/EspiritoRestaurador.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Espirito Restaurador</Text>
                            ...
                            <Text style={styles.textModal}>Durante um período, os pontos de vida do personagem ou do aliado serão restaurados gradualmente com 
                                poder mágico.
                            </Text>
                        </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ProtecaoTelurica.png')} />
                    <Text style={styles.textSkill}>5/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 53, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ProtecaoTelurica.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Proteção Telúrica</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Cria um escudo mágico, aumentando a defesa contra todos os ataques.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ImpactoRelampejante.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 52, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ImpactoRelampejante.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Impacto Relampejante</Text>
                                
                                <Pressable
                                    style={{width: 30, height: 25, backgroundColor: '#000', margin: 3, marginLeft: 47, borderRadius: 5,}}
                                    onPress={() => {
                                    setFour(!four)
                                    }}
                                >
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Isso cega o alvo por algum tempo. O inimigo não poderá atacar nem usar habilidades.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Terremoto.png')} />
                    <Text style={styles.textSkill}>1/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Terremoto.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Terremoto</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Causa um pequeno terremoto, causando dano mágico e reduzindo a velocidade de ataques de todos os 
                                    inimigos em um raio de um metro. Os inimigos não podem se mexem durante o feitiço.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
        ...
        <View style={styles.containerInitial2}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TotemCura.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, }}>
                                    <Image style={styles.ImageModal} source={require('./img/TotemCura.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Totem de Cura</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O xamã coloca um totem de cura no campo de batalha, que restaura periodicamente a vida de todos os 
                                    personagem localizados perto dele.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TotemFogo.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, }}>
                                    <Image style={styles.ImageModal} source={require('./img/TotemFogo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Totem de Fogo</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O xamã coloca um tomte de fogo em um campo de batalha que causa dano a alvos únicos dentro de um raio 
                                    grande. Com uma chance igual à porcentagem de ataques críticos, cada ataque pode aplicar um efeito que causa dano mágico ao alvo 
                                    ao longo do tempo.
                                </Text>
                            </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/PoderTerra.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, }}>
                                    <Image style={styles.ImageModal} source={require('./img/PoderTerra.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Poder da Terra</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta os pontos de vida do personagem ou de seu aliado em determinada porcentagem por algum 
                                    tempo. O poder e tempo do efeito aumentam conforme o nivel da habilidade.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/RitualTribal.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1,}}>
                                    <Image style={styles.ImageModal} source={require('./img/RitualTribal.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Ritual Tribal</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aplica o auxílio Ritual das Chamas ao personagem ou a um aliado por algum tempo. O auxílio aumenta 
                                    a velocidade de ataque e a força de dano crítico.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/EscudoRaios.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/EscudoRaios.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Escudo de Raios</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O xamã é envolto por um escudo de raios. Se o xamã sofrer dano, haverá uma chance de o escudo 
                                    ricochetear dano mágico no atacante.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/PurificacaoXamanica.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/PurificacaoXamanica.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Purificação Xamânica</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Reduz qualquer dano causado ao personagem ou do aliado por algum tempo e remove os efeitos 
                                    negativos do alvo, incluindo efeito de controle.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/CampoEnergia.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1,}}>
                                    <Image style={styles.ImageModal} source={require('./img/CampoEnergia.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Campo de Energia</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aplica o auxílio de saturação de energia a um personagem e aos aliados a alguns metros do personagem 
                                    por algum tempo. O auxílio aumenta a regeneração de energia, a taxa de regeneração de energia e o tempo de recarga da habilidade.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TotemFraqueza.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/TotemFraqueza.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Totem da Fraqueza</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Posiciona um totem no ponto definido por um tempo determinado. A cada 3 segundos, o totem diminui 
                                    os parâmetros de "Acerto crítico", "Penetração" e "Precisão" de todos os inimigos dentro do raio de vários metros por um tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/MaosAncestrais.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/MaosAncestrais.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Mão dos Ancestrais</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Move o aliado selecionado até o personagem, cercando-o com um Campo de Proteção por algum tempo. 
                                    O Campo absorve uma certa quantidadde do dano recebido.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
