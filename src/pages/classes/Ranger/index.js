  ...
  return (
    <ScrollView>
        <View style={styles.containerImage}>
            <Image style={styles.backgroundImage} source={require('./img/Ranger.png')} />
            <View>
        ...
        <View style={styles.describe}>
            ...
            Rápido como o vento, os Patrulheiros dominam as artes do arco e das bestas. 
            os Arqueiros élficos são dotados de grande destreza e conseguem desviar de ataques 
            e revidar com flechas. Eles também sabem usar armadilhas e flechas encantadas para manter 
            os inimigos longe.
            </Text>
        </View>
        ...
        <View style={styles.containerInitial}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TiroPotente.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 50, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/TiroPotente.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Tiro Potente</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Um disparo que causa muito dano físico ao alvo. O dano aumenta conforme o nível da habilidade.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TiroDisperssao.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 50, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/TiroDisperssao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Tiro de Dispersão</Text>
                            ...
                            <Text style={styles.textModal}>Um disparo que tonteia o alvo, fazendo-o recuar um pouco.
                            </Text>
                        </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Evasao.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 52, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/Evasao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Evasão</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Aumenta a chance de desviar de qualquer tipo de ataque.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/BencaoPatrulheiro.png')} />
                    <Text style={styles.textSkill}>5/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 51, height: 50, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/BencaoPatrulheiro.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Benção do Patrulheiro</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O Patrulheiro tem chance de causar dano adicional após qualquer ataque.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ArmadilhaBestas.png')} />
                    <Text style={styles.textSkill}>1/5</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 52, height: 52, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/ArmadilhaBestas.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Armadilha para Feras</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Posiciona uma armadilha que imobilizará o inimigo por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
        ...
        <View style={styles.containerInitial2}>
            ...
            <View style={styles.containerSkill}>
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/FlechasFogo.png')} />
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 48, height: 48, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/FlechasFogo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Flechas de Fogo</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>É lançada uma flecha de fogo que causa dano físico e ateia fogo ao inimigo. Enquanto o alvo estiver 
                                    em chamas, sofrerá dano mágico por determinado período.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/SaraivadaFlechas.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3, width: 49, height: 49, borderWidth: 2, borderColor: '#fa0',}}>
                                    <Image style={styles.ImageModal} source={require('./img/SaraivadaFlechas.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Saraivada de Flechas</Text>
                            ...
                            <Text style={{fontSize: 18, color: '#fff',}}>Tipo: <Text style={{color: '#0f0',}}>Ativo</Text></Text>
                                ...
                                <Text style={{fontSize: 18, color: '#fff',}}>Gasto em energia: <Text style={{color: '#0f0',}}>25 unidades</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>26 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Várias flechas atiradas ao mesmo tempo atingem o alvo e os inimigos em volta. É impossível 
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TiroVingativo.png')} />
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 2}}>
                                    <Image style={styles.ImageModal} source={require('./img/TiroVingativo.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Tiro Vingativo</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Um tiro que cauda dano físico ao alvo e aplica sangramento a todos os adversários, um por um, 
                                    a alguns metros do alvo por algum tempo. Os adversários recebem dano físico períodico. Além disso, aplicará atordoamento ao 
                                    alvo por algum tempo caso esteja sob efeito da Jaula do Caçador
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/Amargura.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3,}}>
                                    <Image style={styles.ImageModal} source={require('./img/Amargura.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Amargura</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Ataques automáticos aumentam a velocidade de ataque do Patrulheiro. A habilidade de 
                                    esquiva de ataques e a chance de acertos críticos aumentam. Número máximo de efeitos: 10.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/TiroCerteiro.png')} />
                    <Text style={styles.textSkill}>4/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/TiroCerteiro.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Tiro Certeiro</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={{fontSize: 18, color: '#fff',}}>Consumo de energia: <Text style={{color: '#0f0',}}>5 unidades em 2s</Text></Text>
                                <Text style={{fontSize: 18, color: '#fff',}}>Recarga: <Text style={{color: '#0f0',}}>8 s</Text></Text>
                            </View>
                                <Text style={styles.textModal}>Aplica um bônus temporário de precisão e poder físico, mas diminui a velocidade de movimento do 
                                    personagem. Habilidade com consumo constante de energia.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/GolpeArco.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1, }}>
                                    <Image style={styles.ImageModal} source={require('./img/GolpeArco.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Golpe de Arco</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Causa dano físico a um inimigo por corpo a corpo e aplica o efeito atordoar por algum tempo. 
                                    O tempo e dano do efeito aumentam conforme o nível de habilidade. O dano também depende do poder físico do personagem e de 
                                    seu nível.
                                </Text>
                            </View>
                        </Modal>      
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/GaiolaCacador.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1,}}>
                                    <Image style={styles.ImageModal} source={require('./img/GaiolaCacador.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Gaiola do Caçador</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O Patrulheiro prende um inimigo em uma cela de energia que o imobiliza por alguns segundos.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ArmadilhaExplosiva.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1,}}>
                                    <Image style={styles.ImageModal} source={require('./img/ArmadilhaExplosiva.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Armadilha Explosiva</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>O Patrulheiro pode armar uma armadilha invisível para os inimigos que causa dano a um alvo e a todos 
                                    os inimigos em volta.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
                ...
                <View style={styles.borderSkill}>
                    <Image style={styles.backgroundSkill} source={require('./img/ArmadilhaDesaceleracao.png')} />
                    <Text style={styles.textSkill}>1/4</Text>
                    <Pressable
                        style={styles.buttons}
                        onPress={() => {
                    ...
                    <View style={styles.containerModal}>
                        ...
                        <View style={styles.modal}>
                            <View style={styles.containerTitleSkill}>
                                <View style={{ margin: 1.3,}}>
                                    <Image style={styles.ImageModal} source={require('./img/ArmadilhaDesaceleracao.png')}/>
                                </View>
                                <Text style={styles.textSKillModal}>Armadilha de Desaceleracão</Text>
                            ...
                            <View style={{margin: 3,}}>
                                ...
                                <Text style={styles.textModal}>Prepara uma armadilha invisível para os inimigos em um ponto específico por um tempo determinado. 
                                    A armadilha causa dano físico ao alvo e a todos os inimigos dentro do raio de alguns metros dele e diminui a velocidade de movimento 
                                    dos inimigos por algum tempo.
                                </Text>
                            </View>
                        </Modal>      
                    </View>
